...
.factory('Main', [function(){ //name of the factory object to be made ('main') 
  return {message: "First"}   //and the contructor function. this function may 
}])                           //call other functions depending on how you design 
                              //it, but it will be returning an object which will
                              //be labeled "Main".
